  ...
  return (
    <>
      <PageHero eyebrow="About" title="A property group, not a builder."
        lede="santi Group is a privately-owned, vertically-integrated property group operating across construction, design, maintenance, warranty and development." />

      <section className="container-x py-24 grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-5">
          <img src={craft} alt="santi workshop" loading="lazy" className="w-full h-[600px] object-cover" />
        </div>
        <div className="lg:col-span-6 lg:col-start-7 space-y-8 text-lg text-ink-soft leading-relaxed">
          <p>Founded in 2008 as a small London refurbishment company, santi has grown into a property group of seventeen divisions, employing trades directly and operating its own joinery workshop, design studio and maintenance teams.</p>
          ...
          <p>What hasn't changed: every project still has a santi director on it. Every project still gets a hand-bound completion document. Every project still receives a warranty written, owned and serviced by us.</p>
        </div>
      </section>
      ...
      <section className="container-x py-24 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <img src={hero} alt="santi project" loading="lazy" className="w-full h-[500px] object-cover" />
      </section>
    </>
  );
}
