...
export const divisions = [
  { slug: "homes", name: "santi Homes", tagline: "Whole-home renovations, extensions and refurbishments.", category: "Construction",
    intro: "From listed-building restorations to contemporary rear extensions, santi Homes delivers full-scope residential construction with a single point of accountability.",
  ...
  { slug: "kitchens", name: "santi Kitchens", tagline: "Designed, supplied and installed by one team.", category: "Construction",
  ...
  { slug: "bathrooms", name: "santi Bathrooms", tagline: "Spa-quality bathrooms, end-to-end.", category: "Construction",
  ...
  { slug: "joinery", name: "santi Joinery", tagline: "Bespoke joinery from our workshop.", category: "Construction",
  ...
  { slug: "roofing", name: "santi Roofing", tagline: "New roofs, repairs and flat-roof systems.", category: "Construction",
  ...
  { slug: "k-render", name: "santi K Render", tagline: "Silicone render and external wall insulation.", category: "Construction",
  ...
  { slug: "landscaping", name: "santi Landscaping", tagline: "Gardens, terraces and outdoor architecture.", category: "Construction",
  ...
  { slug: "interior-design", name: "santi Interior Design", tagline: "Interiors composed with restraint and craft.", category: "Design",
  ...
  { slug: "lighting", name: "santi Lighting", tagline: "Architectural lighting design and installation.", category: "Design",
  ...
  { slug: "smart-homes", name: "santi Smart Homes", tagline: "Automation, AV and cinema rooms.", category: "Design",
  ...
  { slug: "maintenance", name: "santi Maintenance", tagline: "Planned and reactive property care.", category: "Maintenance",
  ...
  { slug: "facilities", name: "santi Facilities", tagline: "Commercial facilities management.", category: "Maintenance",
  ...
  { slug: "electrics", name: "santi Electrics", tagline: "NICEIC-approved electrical contractors.", category: "Maintenance",
  ...
  { slug: "plumbing", name: "santi Plumbing", tagline: "Heating, plumbing and renewables.", category: "Maintenance",
  ...
  { slug: "solar", name: "santi Solar", tagline: "Solar PV, battery storage and EV.", category: "Maintenance",
  ...
  { slug: "hmos", name: "santi HMOs", tagline: "HMO development, conversion and management.", category: "Property",
  ...
  { slug: "developments", name: "santi Developments", tagline: "New build, conversion and joint ventures.", category: "Property",
...
export const testimonials = [
  { quote: "santi delivered a level of finish we had only seen in magazines. The team is unflappable — three years on, we still call them first.", author: "Mr & Mrs H.", project: "Kensington Townhouse" },
